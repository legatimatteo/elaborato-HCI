...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[width=6.5cm]{Screenshots/foglio3/problema62.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[width=6.5cm]{Screenshots/foglio3/problema68.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \hline
    \textbf{Pagina del sito} & Dashboard - I Miei Appunti / Esplora Appunti \\
    \hline
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[width=6.5cm]{Screenshots/foglio3/problema72.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[height=6cm, keepaspectratio]{Screenshots/foglio3/problema73.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[width=6.5cm]{Screenshots/foglio3/problema74.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[width=6.5cm]{Screenshots/foglio3/problema78.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \hline
    \textbf{Pagina del sito} & Dashboard (mobile) \\
    \hline
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[height=6cm, keepaspectratio]{Screenshots/foglio3/problema80.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[width=6.5cm]{Screenshots/foglio3/problema83.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \hline
    \textbf{Pagina del sito} & Dashboard - Strumenti AI  \\
    \hline
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|>{\raggedright\arraybackslash}p{7.5cm}|>{\raggedright\arraybackslash}p{7.5cm}|}
    ...
    \textbf{Screen} &
    \vspace{10pt}
    \hspace*{\fill}\includegraphics[height=6cm, keepaspectratio]{Screenshots/foglio3/problema90.png}\hspace*{\fill}
    \vspace{10pt}
    \\
    \hline
    \textbf{Nome del valutatore} & Kharef \\
