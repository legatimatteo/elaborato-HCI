...
Per una visione d'insieme più sintetica, le violazioni sono state raggruppate nelle tre principali categorie in cui si suddivisono i principi di Nielsen: \textit{percezione}, \textit{cognizione} ed \textit{errori}. La distribuzione percentuale è mostrata nel grafico sottostante.
