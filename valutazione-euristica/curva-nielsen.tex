...
Sulla base di questa stima, è possibile ottenere una valutazione del numero totale di problemi presenti. Indicando con $P$ il numero di problemi rilevati e con $N$ il numero totale di problemi esistenti, si ha:
\[
	P : N = 67.2 : 100
\]
