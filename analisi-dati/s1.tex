...
Per quanto riguarda il gruppo B--A, si osserva che l'esperienza accumulata sulla versione B ha consentito di completare la versione A con un tempo medio inferiore rispetto a chi non l'aveva mai provata; tuttavia, questa riduzione temporale si configura come un andamento positivo ma non determinante sotto il profilo inferenziale. Parimenti, l'incremento nel numero medio di errori nel passaggio dall'interfaccia riprogettata a quella originale rappresenta una semplice tendenza descrittiva che non assume rilevanza statistica. Al contrario, il numero medio di click subisce un progresso netto e confermato sul piano statistico nel passaggio alla versione B (in cui si registra un decremento del 55,80\% rispetto alla versione A): questo dimostra che l'interfaccia originale costringe gli utenti a compiere molti più passaggi, indipendentemente dalla loro familiarità con il compito.
