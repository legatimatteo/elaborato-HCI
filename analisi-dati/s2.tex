...
Nel gruppo caratterizzato dall'ordine B--A, il tempo medio di esecuzione mostra un incremento nel passaggio dalla versione riprogettata a quella originale (da 2.34.50 a 2.57.00). Tale variazione è tuttavia da interpretare come un semplice trend descrittivo, non risultando statisticamente significativa. Al contrario, le altre metriche operative evidenziano un netto peggioramento nel passaggio alla versione A, confermato anche dai test inferenziali. In particolare, la media degli errori aumenta dell'800,00\% (da 0,17 a 1,50), mentre il numero medio di click cresce del 150,47\% (da 17,83 a 44,67).

Questo andamento evidenzia un marcato disallineamento tra le metriche: nonostante il tempo di completamento aumenti solo moderatamente (+14,32\%), gli utenti compiono un numero significativamente maggiore di click e commettono molti più errori. Tale comportamento è riconducibile a una strategia di \textit{trial and error}. Avendo già completato lo scenario nella Versione B, gli utenti avevano infatti compreso l'obiettivo del compito e acquisito familiarità con la sequenza delle operazioni da svolgere. Di conseguenza, il tempo necessario per completare l'attività cresce solo marginalmente.

Tuttavia, questa familiarità non è sufficiente a compensare i limiti strutturali della Versione A. L'architettura dell'informazione non rende infatti immediatamente individuabile il percorso corretto per raggiungere l'obiettivo: la disposizione delle funzionalità e la scarsa chiarezza dell'interfaccia costringono gli utenti a esplorare percorsi alternativi e a procedere per tentativi. Ne consegue un aumento significativo del numero di click e degli errori, a conferma del fatto che le difficoltà riscontrate dipendono principalmente dall'organizzazione dell'interfaccia piuttosto che dalla mancata comprensione del compito.
