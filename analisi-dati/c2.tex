...
\begin{figure}[H]
	...
	\label{fig:difficolta-c2-generale}
\end{figure}
...
Nel gruppo B-A, il tempo mediano iniziale sulla versione B is pari a 1:56, mentre nella successiva esecuzione sulla versione A si osserva un valore pari a 1:38. Questo andamento suggerisce la presenza di un possibile effetto di apprendimento, tuttavia non consente di identificare un transfer sistematico e unidirezionale tra le due interfacce. In particolare, l’esperienza sulla versione B sembra aver fornito alcuni schemi operativi utili, ma non sufficienti a neutralizzare completamente le inefficienze strutturali della versione originale.
...
\begin{figure}[H]
	...
	\label{fig:difficolta-c2-ordine-confronto}
\end{figure}
