...
I dati sulla difficoltà percepita (Figura~\ref{fig:6-c6-2}) rivelano un andamento particolare. Nel gruppo A--B c'è il solito miglioramento: si parte da un punteggio di 1,67 con la vecchia versione (A) e si scende a 1,33 con la versione B, confermando che la nuova interfaccia è più comoda. Nel gruppo B--A, invece, succede una cosa curiosa e al contrario rispetto agli altri compiti: chi usa prima la versione B dà un voto di 1,33, ma quando passa alla vecchia versione A la difficoltà cala addirittura a 1,17. Questo accade perché l'aver usato prima la versione B ha fatto memorizzare perfettamente agli utenti dove si trovava l'area dei commenti; una volta capita la posizione, completare il compito sulla versione A è stato così rapido che gli utenti lo hanno percepito come ancora più facile. Inoltre, il voto della versione B resta fisso a 1,33 in tutti e due i gruppi, segno che il giudizio sul nuovo sistema è solido e non cambia in base all'ordine del test.
