...
In primo luogo, abbiamo progettato l'esperienza, descrivendo in modo dettagliato l'oggetto di studio, ovvero \textit{BrainBox}, il sistema che intendiamo analizzare. In questa fase abbiamo pianificato l'organizzazione temporale delle attività, definendo le scadenze e la distribuzione dei compiti all'interno del gruppo.
