...
Il testo dell'interfaccia è stato interamente tradotto in italiano. Il pulsante \textit{"Passa a BrainBox Pro +"} (P17), presente nella versione precedente senza alcuna funzione attiva, è stato rimosso. \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{./figures/fig-riprogettazione-fisica/dashboard/dashboard.png}
    \caption{Dashboard}
    \label{fig:dashboard}
\end{figure}