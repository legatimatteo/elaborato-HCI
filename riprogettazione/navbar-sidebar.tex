...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{figures/fig-riprogettazione-fisica/navbar-sidebar/calendario.png}
        \caption{Calendario}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{figures/fig-riprogettazione-fisica/navbar-sidebar/notifiche.png}
        \caption{Notifiche}
