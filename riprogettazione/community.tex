...
\item P69 (Nessuna distinzione visiva tra proprie risorse e risorse altrui): La distinzione 
è stata risolta separando i due contesti a livello strutturale. Nella sezione Community 
vengono visualizzati tutti i documenti condivisi dalla piattaforma, inclusi i propri, 
senza necessità di distinguerli visivamente in quanto il contesto è per natura esplorativo. 
Per consultare esclusivamente i propri contenuti condivisi, l'utente può invece accedere 
alla sezione "Appunti" e selezionare il tab "Appunti condivisi", che funge da filtro 
rapido dedicato.